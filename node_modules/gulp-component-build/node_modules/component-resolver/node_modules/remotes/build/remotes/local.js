...
Local.prototype.resolve = wrapGenerator.mark(function(remotes, repo, ref) {
  var folders;
  ...
  return wrapGenerator(function($ctx0) {
    ...
    case 8:
      return $ctx0.delegateYield(this.folders(repo), "t0", 9);
    case 9:
      folders = $ctx0.t0;
...
Local.prototype.folders = wrapGenerator.mark(function(repo) {
  ...
  return wrapGenerator(function($ctx1) {
    ...
    case 8:
      ...
      return $ctx1.abrupt("return", folders.filter(noLeadingDot));
    case 13:
      $ctx1.prev = 13;
...
Local.prototype._versions = wrapGenerator.mark(function(repo) {
  return wrapGenerator(function($ctx2) {
    while (1) switch ($ctx2.prev = $ctx2.next) {
    case 0:
      return $ctx2.delegateYield(this.folders(repo), "t2", 1);
    case 1:
      return $ctx2.abrupt("return", $ctx2.t2);
    case 2:
    case "end":
      return $ctx2.stop();
    }
...
Local.prototype._json = wrapGenerator.mark(function(repo, ref) {
  var body, filename;
  ...
  return wrapGenerator(function($ctx3) {
    ...
    case 7:
      $ctx3.prev = 7;
      $ctx3.t3 = $ctx3.catch(1);

      if (!($ctx3.t3.code === 'ENOENT')) {
        $ctx3.next = 11;
        break;
      }
    ...
    case 12:
      $ctx3.prev = 12;
      return $ctx3.abrupt("return", JSON.parse(body));
    case 16:
      $ctx3.prev = 16;
      $ctx3.t4 = $ctx3.catch(12);
...
Local.prototype._tree = wrapGenerator.mark(function() {
