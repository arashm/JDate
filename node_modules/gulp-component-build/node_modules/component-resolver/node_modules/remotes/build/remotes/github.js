...
GitHub.prototype._versions = wrapGenerator.mark(function(repo) {
  var uri, res, err;
  ...
  return wrapGenerator(function($ctx0) {
    ...
    case 0:
      ...
      debug('GET "%s"', uri);
      API_COUNTER++;
      return $ctx0.delegateYield(this.request(uri, true), "t0", 4);
    case 4:
      res = $ctx0.t0;
    ...
    case 10:
      ...
      return $ctx0.abrupt("return", errorRateLimitExceeded(res));
    case 12:
      ...
      return $ctx0.abrupt("return", errorBadCredentials(res));
    case 14:
    ...
    case 19:
      ...
      return $ctx0.abrupt("return", res.body.map(name));
    case 21:
    case "end":
      return $ctx0.stop();
    }
...
GitHub.prototype._json = wrapGenerator.mark(function(repo, ref) {
  ...
  return wrapGenerator(function($ctx1) {
    ...
    case 5:
      ...
      debug('GET "%s"', uri);
      $ctx1.prev = 8;
      return $ctx1.delegateYield(this.request(uri, true), "t1", 10);
    case 10:
      res = $ctx1.t1;
      $ctx1.next = 17;
      break;
    case 13:
      $ctx1.prev = 13;
      $ctx1.t2 = $ctx1.catch(8);
      debug('error when GETing "%s": "%s', uri, $ctx1.t2.message);
      return $ctx1.abrupt("continue", 20);
    case 17:
      if (!(res.statusCode !== 200)) {
        $ctx1.next = 19;
        break;
      ...
      return $ctx1.abrupt("continue", 20);
    case 19:
      return $ctx1.abrupt("return", res.body);
    case 20:
      j++;
      $ctx1.next = 5;
      break;
...
GitHub.prototype._tree = wrapGenerator.mark(function(repo, ref) {
  var uri, res, err;
  ...
  return wrapGenerator(function($ctx2) {
    ...
    case 0:
      ...
      debug('GET "%s"', uri);
      API_COUNTER++;
      return $ctx2.delegateYield(this.request(uri, true), "t3", 4);
    case 4:
      res = $ctx2.t3;
      ...
      return $ctx2.abrupt("return", malformedJSON(uri, res));
    case 7:
      if (!(res.statusCode === 404)) {
        $ctx2.next = 9;
        break;
    ...
    case 9:
      ...
      return $ctx2.abrupt("return", errorRateLimitExceeded(res));
    case 11:
      if (!(res.statusCode === 401)) {
        $ctx2.next = 13;
        break;
      ...
      return $ctx2.abrupt("return", errorBadCredentials(res));
    case 13:
      if (!(res.statusCode !== 200)) {
        $ctx2.next = 18;
        break;
    ...
    case 18:
      checkRateLimitRemaining(res);
      return $ctx2.abrupt("return", res.body.tree.filter(isBlob));
    case 20:
    case "end":
      return $ctx2.stop();
    }
