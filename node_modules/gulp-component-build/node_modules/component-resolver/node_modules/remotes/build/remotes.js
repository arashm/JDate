...
Remotes.prototype.resolve = wrapGenerator.mark(function(remotes, name, reference) {
  ...
  return wrapGenerator(function($ctx0) {
    ...
    case 8:
      ...
      return $ctx0.delegateYield(instances[i].resolve(remotes, name, reference), "t0", 10);
    case 10:
      if (!$ctx0.t0) {
        $ctx0.next = 12;
        break;
      ...
      return $ctx0.abrupt("return", instances[i]);
    case 12:
      i++;
      $ctx0.next = 8;
      break;
