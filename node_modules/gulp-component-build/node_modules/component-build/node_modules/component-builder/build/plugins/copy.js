...
module.exports = function () {
  return wrapGenerator.mark(function copy(file) {
    var out;

    return wrapGenerator(function copy$($ctx0) {
      ...
      case 4:
        return $ctx0.delegateYield(utils.unlink(out), "t1", 5);
      case 5:
        $ctx0.next = 7;
        return cp.bind(null, file.filename, out);
      case 7:
      case "end":
        return $ctx0.stop();
      }
